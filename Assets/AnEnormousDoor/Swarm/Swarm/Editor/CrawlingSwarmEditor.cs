...
namespace Swarm
{
    ...
    public class CrawlingSwarmEditor : Editor
    {
        ...
        SerializedProperty pauseCurve;
        SerializedProperty pauseThreshold;

        SerializedProperty pauseFrequency;
        ...
        void OnEnable()
        {
            ...
            pauseCurve = serializedObject.FindProperty("pauseCurve");
            pauseThreshold = serializedObject.FindProperty("pauseThreshold");
            pauseFrequency = serializedObject.FindProperty("pauseFrequency");
        }
        ...
        public override void OnInspectorGUI()
        {
            ...
            EditorGUILayout.PropertyField(pauseCurve);
            EditorGUILayout.PropertyField(pauseThreshold);
            EditorGUILayout.PropertyField(pauseFrequency);
